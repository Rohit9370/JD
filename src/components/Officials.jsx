...
const Officials = () => {
  ...
  const OfficialCard = ({ official }) => (
    <div className="group bg-white rounded-lg shadow-lg p-4 text-center hover:shadow-xl transition-shadow duration-300">
      <div className="relative mx-auto mb-3 overflow-hidden rounded-lg bg-white w-[150px] h-[150px] flex items-center justify-center">
        <img
          src={official.image}
          alt={official.name}
          className="max-w-full max-h-full object-contain transition-transform duration-300 ease-out group-hover:scale-x-120 "
          onError={(e) => {
